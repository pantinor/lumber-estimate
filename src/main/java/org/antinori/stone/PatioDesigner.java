...
public class PatioDesigner extends SimpleGame {
    ...
    public Map<String, StoneInstance> modelInstances = new TreeMap<String, StoneInstance>();
    ...
    /**
     * Draw text to a texture that can be applied to the box faces for easy
     * identification and selection with a label.
     */
    public Texture drawText(String... text) {
        ...
        for (int i = 0; i < text.length; i++) {
            GlyphLayout layout = new GlyphLayout(ftFont, text[i], Color.WHITE, width, Align.left, true);

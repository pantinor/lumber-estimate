...
public enum StoneType {
    ...
    CUSTOM("Custom 1x1x48",
            new Vector3(-.5f, -.5f, -24f), new Vector3(.5f, -.5f, -24f), new Vector3(-.5f, -.5f, 24f), new Vector3(.5f, -.5f, 24f),
            new Vector3(-.5f, .5f, -24f), new Vector3(.5f, .5f, -24f), new Vector3(-.5f, .5f, 24f), new Vector3(.5f, .5f, 24f), 1f);
